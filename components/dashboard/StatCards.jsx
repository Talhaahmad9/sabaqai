  ...
  const cards = [
    {
      ...
      bottomText:
        hoursStudied === 0
          ? "Keep studying!"
          : `~${Math.round(hoursStudied * 60)} minutes total`,
    ...
    },
    {
      ...
      bottomText:
        topicsCovered === 0
          ? "Start chatting!"
          : `${topicsCovered} concept${topicsCovered === 1 ? "" : "s"} learned`,
    ...
    },
    {
      ...
      bottomText:
        weakTopicsCount === 0
          ? "Nothing to revise"
          : `${weakTopicsCount} need${weakTopicsCount === 1 ? "s" : ""} revision`,
